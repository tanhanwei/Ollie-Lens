...
//import 'https://github.com/aave/lens-protocol/blob/f7e98ca2411745af58a7dfcf6940700f40e0c704/contracts/core/LensHub.sol';
...
contract LensGiveaway is VRFConsumerBaseV2 {
    ...
    //--------------------------LENS HUB FUNCTIONS-------------------------------
    function getProfileFollowNFT (address _lensHub, uint256 participantId) external view returns (address) {
        return ILensHub(_lensHub).getFollowNFT(participantId);
    }
